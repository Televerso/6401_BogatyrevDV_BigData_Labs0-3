...
public class HourlyTipsExercise extends ExerciseBase {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<Tuple3<Long,Long,Float>> max_tips = (fares.keyBy((TaxiFare fare)->fare.driverId)
				.timeWindow(Time.hours(1))
				.process(new SumTips())
				.timeWindowAll(Time.hours(1))
				.maxBy(2)
		);
		printOrTest(max_tips);

		// execute the transformation pipeline
		env.execute("Hourly Tips (java)");
	}

	private static class SumTips extends ProcessWindowFunction<
			TaxiFare, Tuple3<Long,Long,Float>, Long, TimeWindow> {

		@Override
		public void process(Long key, ProcessWindowFunction<TaxiFare, Tuple3<Long, Long, Float>, Long, TimeWindow>.Context context,
